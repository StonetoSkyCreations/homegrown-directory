...
description: Regenerative organic farm and online grocer delivering organic fruit, vegetables and dry goods direct to customers and stocking select produce from Streamside Organics.
practices:
...
products:
  ...
  - organic eggs
  - dairy and tofu
  - dry goods including grains, nuts, seeds, pulses and flour
  - produce from partner farms
services:
  - farm-to-door delivery using chilled trucks
  - nationwide courier shipping
  - custom orders and subscription boxes
  - local pickup with swap-a-crate system
website: https://live2giveorganics.nz
email: online@live2give.nz
phone: "+64 21 680 894"
social:
hours:
market_days: []
